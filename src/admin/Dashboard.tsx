...
const AdminDashboard = () => {
  ...
  const s = {
    ...
    title:      { fontSize: '22px', fontWeight: 800, color: '#60a5fa', letterSpacing: '-0.02em' },
  ...
  return (
    <div style={s.page}>
      ...
      <div style={s.header}>
        <div>
          <div style={s.title}>🏛️ Harsh CSC — Admin Control Room</div>
          <div style={{ fontSize: '12px', color: '#64748b', marginTop: '4px' }}>eMitra Service Management</div>
        </div>
